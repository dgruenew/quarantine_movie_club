...
Individuals of varying (and often suspect) taste were asked to rank watchability of movies from 1 (best) to 8 (worst).
...
On down the list, you have the lesser movie critics, with indisputably irrational preferences. Timestamps are provided, but you know who you are

#### Sum of Squared Differences

According to some, the sum of squared differences is a demonstrably poorer metric than mean absolute deviation, but we indulge the reader.
